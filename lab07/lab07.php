...
<head>
  ...
  <link href="styles/dl.css" rel="stylesheet">
...
<body>
   <header>
	<?php
			$cssinfo = "CSSSSSSS";
			echo "<h1>HTML 5 Basic Content Elements with $cssinfo Layout</h1>";
	?>
    </header> 
	?>
	<nav>
	  ...
	  <ol>
		...
		<section id="hyperlinks">
		  ...
		  <p>This is a link to the <a href="#lists">List Section </a> of the Web page</p>
